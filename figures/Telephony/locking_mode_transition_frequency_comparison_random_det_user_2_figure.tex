...
\begin{minipage}{1\textwidth}
  ...
  \makebox[\textwidth][c]{ %
        \resizebox{1.19\textwidth}{!}{ %
            \input{figures/Telephony/locking_mode_transition_frequency_comparison_random_det_user_2_plot.pgf}
        }%
    }%
\end{minipage}
...
\label{figure:locking_mode_transition_frequency_comparison_telephony_random_det_user_2}
\end{figure}